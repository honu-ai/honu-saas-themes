import HeroSection from '@/components/axiom/hero-section';
import ProblemSection from '@/components/axiom/problem-section';
import SolutionSection from '@/components/axiom/solution-section';
import BenefitsSection from '@/components/axiom/benefits-section';
import FaqSection from '@/components/axiom/faq-section';
import { parsePageContent, type SearchParams } from '@/lib/page-content';
import CtaSection from '@/components/axiom/cta-section';
import Footer from '@/components/axiom/footer';
...
export default async function AxiomHomePage({ searchParams }: PageProps) {
