...
import '../../components/friendly/globals.css';
...
export default function Layout({ children }: { children: React.ReactNode }) {
  useEffect(() => {
    ...
    document.documentElement.classList.add(montserrat.className);
    document.documentElement.classList.add('theme-friendly');

    return () => {
      // Clean up when leaving friendly theme
      document.documentElement.classList.remove(montserrat.className);
